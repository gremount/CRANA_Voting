...
int main()
{
	...
	outfile<<"graph_ATT网络拓扑 case_num: "<<case_num<<endl;
	...
	vector<Voter*> neutralL;//记录所有的中立者
	...
	//统计所有case结果的平均值
	double app_happiness=0;
	double app_latency=0;
	double app_te=0;

	double voting_happiness=0;
	double voting_latency=0;
	double voting_te=0;

	double net_happiness=0;
	...
	for(int icase=0;icase<case_num;icase++)
	{
		...
		for(int i=0;i<10;i++)
		{
			neutralL.push_back(new Neutral(flowL.size()+i+1, 2) );
			neutralL[i]->te = (i+1)/10.0;
		}
		...
		*/
		...
		app_happiness += happiness_flow/flowL.size();
		app_latency += latencyVoting_flow;
		app_te += maxUtil_Voting_flow;
		...
		voting_happiness += happiness/flowL.size();
		voting_latency += latencyVoting;
		voting_te += maxUtil_Voting;
		...
		net_happiness += judge_LP/flowL.size();
		net_latency += latency_LP;
		net_te += result_LP;

	}		

	outfile<<"---------------- average result of "<<case_num<<" cases --------------"<<endl;
	outfile<<"applications result: "<<endl;
	outfile<<"app_happiness = "<<app_happiness/case_num<<endl;
	outfile<<"app_latency = "<<app_latency/case_num<<endl;
	outfile<<"app_te = "<<app_te/case_num<<endl;

	outfile<<"voting result: "<<endl;
	outfile<<"voting_happiness = "<<voting_happiness/case_num<<endl;
	outfile<<"voting_latency = "<<voting_latency/case_num<<endl;
	outfile<<"voting_te = "<<voting_te/case_num<<endl;

	outfile<<"network result: "<<endl;
	outfile<<"net_happiness = "<<net_happiness/case_num<<endl;
	outfile<<"net_latency = "<<net_latency/case_num<<endl;
	outfile<<"net_te = "<<net_te/case_num<<endl;
